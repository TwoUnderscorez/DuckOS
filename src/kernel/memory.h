...
extern unsigned int __cdecl swapPageDirectoryAsm(unsigned int *ptr);
extern void __cdecl enablePagingAsm(void);
extern void __cdecl enablePaePagingAsm(void);
extern void __cdecl disablePagingAsm(void);
